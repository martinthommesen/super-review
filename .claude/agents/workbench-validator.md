...
description: Validates super-review workbench changes with check, lint, and optional companion/coverage/spec. Use after editing repository tooling, docs, CI, companion, or tests.
---
...
3. When any path under `companion/` changed, also run `make companion-test` — root gates intentionally exclude companion.
